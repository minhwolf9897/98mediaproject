                    ...
                    <div class="card-body mx-4 mt-4">
                        ...
                        <form action="/admin/category/{{$obj->id}}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Tên</label>
                                <div class="row ml-1">
                                    <input type="text" name="name" class="form-control w-25 mr-2" value="{{$obj -> name}}">
                                    @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control w-50" style="display: block!important;" value="{{$obj -> type}}">
