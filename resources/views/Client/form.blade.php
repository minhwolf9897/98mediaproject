...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" id="navbar">
        <div class="container"><a class="navbar-brand" href="client"><img style="width: 100px; height: auto" src="{{asset('img/Untitled-1.png')}}"></a>
            ...
            <div class="collapse navbar-collapse" >
                <ul class="navbar-nav ml-auto" style="font-family: 'Roboto', sans-serif">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#projects">Dịch vụ</a></li>
                    <li class="nav-item"><a class="nav-link" href="#pricing">Sản phẩm</a></li>
...
<div id="content">
    <section class="row no-gutters" id="features">
        <div class="col-lg-3 col-md-6 col-sm-12 bg-blue lighten-1 text-white">
                    ...
                    <div class="card card-image">
                        <div class="text-white text-center pricing-card d-flex align-items-center rgba-stylish-strong py-3 px-3 rounded">
                            <div class="card-body">
                                ...
                                </ul><a class="btn btn-outline-white mt-5"> Tôi chọn dịch vụ này ! </a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row center-on-small-only">
                <div class="col-lg-6 col-md-12 mb-r " data-wow-delay=".3s">
                    <div class="col-md-6 float-left"><img class="img-fluid  mb-3" src="https://www.facebook.com/photo.php?fbid=1716657255117645&set=a.110062329110487.13060.100003201619930&type=3&theater" alt="team member"/></div>
                    <div class="col-md-6 float-right">
